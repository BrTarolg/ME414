...
1.  Making a corpus and corpus structure
    ...
    1.  From a vector of texts already in memory. 
        ...
        for example `data_corpus_inaugural` is the UTF-8 encoded corpus of 58 presidential inaugural
        ...
        description of the corpus.  The names of the character vector `data_corpus_inaugural` should
